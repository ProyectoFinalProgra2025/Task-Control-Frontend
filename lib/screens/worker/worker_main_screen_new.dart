...
/// Worker Main Screen - Versión optimizada con chat accesible
class WorkerMainScreenNew extends StatefulWidget {
  const WorkerMainScreenNew({super.key});

  @override
  State<WorkerMainScreenNew> createState() => _WorkerMainScreenNewState();
}

class _WorkerMainScreenNewState extends State<WorkerMainScreenNew> with SingleTickerProviderStateMixin {
  int _currentIndex = 0;
          ...
          child: SafeArea(
            child: Padding(
              ...
              child: Row(
                ...
                children: [
                  _buildNavItem(Icons.home_outlined, Icons.home_rounded, 'Inicio', 0, isDark),
                  _buildNavItem(Icons.chat_outlined, Icons.chat_rounded, 'Chat', 1, isDark),
                  _buildNavItem(Icons.person_outlined, Icons.person_rounded, 'Perfil', 2, isDark),
                ],
              ),
            ),
          ),
